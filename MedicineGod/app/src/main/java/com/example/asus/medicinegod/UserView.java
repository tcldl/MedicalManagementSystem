...
public class UserView extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    private RadioButton rb_Home,rb_Search,rb_History,rb_Shop,rb_Center;
    ...
    private void initView() {
        mRadioGroup = (RadioGroup) findViewById(R.id.radiobutton_user_view_main);
        rb_Home= (RadioButton) findViewById(R.id.radiobutton_user_main_mainpage);
        rb_Search= (RadioButton) findViewById(R.id.radiobutton_user_main_search);
        rb_Shop= (RadioButton) findViewById(R.id.radiobutton_user_main_shop);
        rb_Center= (RadioButton) findViewById(R.id.radiobutton_user_main_center);
    }
    ...
    public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
        ...
        transaction=fm.beginTransaction();
        switch (checkedId){
            case R.id.radiobutton_user_main_mainpage:
                fragment=fragments.get(0);
                transaction.replace(R.id.mFragment,fragment);
                break;
            case R.id.radiobutton_user_main_search:
                fragment=fragments.get(1);
                transaction.replace(R.id.mFragment,fragment);
                break;
            case R.id.radiobutton_user_main_shop:
                fragment=fragments.get(2);
                transaction.replace(R.id.mFragment,fragment);
                break;
            case R.id.radiobutton_user_main_center:
